...
struct R {
    static let name = "🐛CaterpillarDev🐛"
    static let desc = "A description of CaterpillarDev"
...
"""
    ...
    static let primerPath = Path("/primer.css")
    static let highlighPath = Path("/highlight.css")
    static let usDateFormat = "d MMMM yyyy"
}
